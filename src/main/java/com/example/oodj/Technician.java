...
public class Technician extends User implements Database {
    ...
    public Technician(String input_id){
        super.set_id(input_id);

    }

    public Technician(String input_id, String input_password, String input_phone_number){
    ...
    public void registration(String name, String ic, String phone_number, String email_address, String password){
        ...
        try {
            BufferedReader reader = new BufferedReader(new FileReader(technician_filepath));
        ...
        String id = "te" + ("000000" + number_id).substring(String.valueOf(number_id).length());
        super.set_id(id);
        ...
        try {
            PrintWriter pw = new PrintWriter(new FileWriter(technician_filepath, true));
            pw.println(newLine);
            pw.close();
    ...
    public void find_user_with_email_address(String email_address) {
        ...
        try {
            scanner = new Scanner (new File(technician_filepath));
    ...
    public void edit_password(String id, String new_password) {
        ...
        try (FileReader fr = new FileReader(technician_filepath)) {
        ...
        try (PrintWriter pr = new PrintWriter(technician_filepath)) {
    ...
    public static String[] filter_these_technician(String [] unavailable_technician){

        String [] available_technician = {};
        List<String> available_technician_list = new ArrayList<>(Arrays.asList(available_technician));

        List<String> unavailable_technician_list = new ArrayList<>(Arrays.asList(unavailable_technician));
        ...
        try (FileReader fr = new FileReader(technician_filepath)) {
            ...
            while ((line = scanner.nextLine()) != null) {
                ...
                if (!unavailable_technician_list.contains(lineArr[0])) {

                    available_technician_list.add(lineArr[0].toUpperCase());
        ...
        available_technician = available_technician_list.toArray(available_technician);
