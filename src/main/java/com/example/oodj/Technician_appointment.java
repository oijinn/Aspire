...
public class Technician_appointment implements Initializable {
    ...
    void btn_menu_profile_clicked(MouseEvent event) {
        change_scene(btn_menu_profile, "Technician_profile.fxml");
    }
        ...
        table.setRowFactory(tv -> {
            ...
            row.setOnMouseClicked(event -> {
                if (event.getClickCount() == 2 && (! row.isEmpty()) ) {
                    ...
                    change_scene(btn_menu_appointment, "Technician_appointment_summary.fxml");
                }
            });
            return row ;
        });
