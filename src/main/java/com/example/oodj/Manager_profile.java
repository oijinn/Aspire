...
public class Manager_profile implements Initializable {
    ...
    private void import_current_user_profile(){
        ...
        lbl_user_name.setText(manager.get_name().toUpperCase());
        lbl_user_id.setText(manager.get_id().toUpperCase());
        lbl_user_ic.setText(manager.get_ic());

        lbl_user_email_address.setText(manager.get_email_address());
        txt_unmask_password.setText(manager.get_password());
        txt_mask_password.setText(manager.get_password());

        txt_user_phone_number.setText(manager.get_phone_number());
    }
